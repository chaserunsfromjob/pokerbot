...
class GameUtility:
    ...
    def evaluate_hand(self, hand: np.ndarray) -> int:
        ...
        -------
            Evaluation of hand
        """
        # VENDOR PATCH (numpy>=1.24 compat): `np.int` was removed from numpy.
        # It was only ever an alias for the builtin `int`, so swapping it for
        # `int` is behaviour-identical and touches no poker logic.
