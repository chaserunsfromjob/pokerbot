...
| 2 | Position-aware preflop and separately authored card-aware controls make screening informative | Three controls implemented; 25,920-hand precision screen complete | No consistent improvement from precision/margin/sizing variants; now investigate conditional ranges and position-aware candidate policies | Controls share the equity evaluator and are not established strong opponents |
