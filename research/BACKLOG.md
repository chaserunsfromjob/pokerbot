...
| Done | Extend confirmation to typed strategy configurations | Equity/river/turn round-trip and dispatch tests pass | Legacy format support, strict source/runtime matching, partial-log recovery and shared alpha ledger retained | External/trained and range-policy confirmation still unsupported; no real attempt allocated |
